...
int main(void *arg){
    ...
    l = pthread_create(&threads[3], NULL, prime_50001_62500, NULL);
    m = pthread_create(&threads[4], NULL, prime_62501_75000, NULL);
    n = pthread_create(&threads[5], NULL, prime_75001_87500, NULL);
    o = pthread_create(&threads[6], NULL, prime_87501_100000, NULL);
